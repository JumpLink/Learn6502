      ...
      export module material {
        export module materialswitch {
            ...
            extends androidx.appcompat.widget.SwitchCompat
          {
            ...
            public setTrackDecorationTintList(
              param0: globalAndroid.content.res.ColorStateList
            ): void;
            public getTrackDecorationTintList(): globalAndroid.content.res.ColorStateList;
            public setTrackDecorationTintMode(
              param0: globalAndroid.graphics.PorterDuff.Mode
            ): void;
            public getTrackDecorationTintMode(): globalAndroid.graphics.PorterDuff.Mode;
            public setTrackDecorationDrawable(
            ...
            public sendAccessibilityEventUnchecked(
              param0: globalAndroid.view.accessibility.AccessibilityEvent
            ): void;
            ...
            public onKeyDown(
              param0: number,
              param1: globalAndroid.view.KeyEvent
            ): boolean;
            public onKeyUp(
              param0: number,
              param1: globalAndroid.view.KeyEvent
            ...
            public onKeyMultiple(
              param0: number,
              param1: number,
              param2: globalAndroid.view.KeyEvent
            ): boolean;
          }
        }
      }
