...
export const components = {
  ...
  // Heading elements
  h1: (props: any) => (
    <NsHtmlView {...props} className="title-1">
      {props.children}
    </NsHtmlView>
  ),
  h2: (props: any) => (
    <NsHtmlView {...props} className="title-2">
      {props.children}
    </NsHtmlView>
  ),
  h3: (props: any) => (
    <NsHtmlView {...props} className="title-3">
      {props.children}
    </NsHtmlView>
  ),
  h4: (props: any) => (
    <NsHtmlView {...props} className="title-4">
      {props.children}
    </NsHtmlView>
  ),
  ...
  // Text elements
  p: (props: any) => (
    <NsHtmlView {...props} className="body">
      {props.children}
    </NsHtmlView>
  ),
  ...
  ul: (props: any) => (
    <NsHtmlView {...props} className="list">
