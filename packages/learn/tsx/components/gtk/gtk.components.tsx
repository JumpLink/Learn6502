...
export const GtkComponents: MDXComponents = {
    ...
    h5: (props: any) => <GtkLabel {...props} use-markup wrap hexpand-set hexpand halign={Align.FILL} xalign={0} margin-top={12} margin-bottom={12} class="title-5">{props.children}</GtkLabel>,
    h6: (props: any) => <GtkLabel {...props} use-markup wrap hexpand-set hexpand halign={Align.FILL} xalign={0} margin-top={12} margin-bottom={12} class="title-6">{props.children}</GtkLabel>,
